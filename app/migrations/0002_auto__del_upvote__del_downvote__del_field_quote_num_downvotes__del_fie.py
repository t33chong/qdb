...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Quote.rating_likes'
        db.add_column(u'app_quote', 'rating_likes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)

        # Adding field 'Quote.rating_dislikes'
        db.add_column(u'app_quote', 'rating_dislikes',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Quote.rating_likes'
        db.delete_column(u'app_quote', 'rating_likes')

        # Deleting field 'Quote.rating_dislikes'
        db.delete_column(u'app_quote', 'rating_dislikes')
